...
authoritative for this repository. Do not summarise, compress or adapt it here; when the source
changes, re-import it whole in the same change that changes the source.
